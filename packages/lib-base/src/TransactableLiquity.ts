...
export interface TransactableLiquity {
   ...
   *                           {@link lib-base-u#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link lib-base-u#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link lib-base-u#LUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link lib-base-u#StabilityDeposit.collateralGain | collateral gain} and
   * {@link lib-base-u#StabilityDeposit.lqtyReward | LQTY reward}.
   */
  ...
  /**
   * Withdraw {@link lib-base-u#StabilityDeposit.collateralGain | collateral gain} and
   * {@link lib-base-u#StabilityDeposit.lqtyReward | LQTY reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link lib-base-u#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link lib-base-u#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link lib-base-u#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link lib-base-u#LQTYStake.collateralGain | collateral gain} and
   * {@link lib-base-u#LQTYStake.lusdGain | LUSD gain}.
   */
  ...
  /**
   * Withdraw {@link lib-base-u#LQTYStake.collateralGain | collateral gain} and
   * {@link lib-base-u#LQTYStake.lusdGain | LUSD gain} from LQTY stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * {@link lib-base-u#TransactableLiquity.stakeUniTokens | staking}.
   *
   ...
   * {@link lib-base-u#TransactableLiquity.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
