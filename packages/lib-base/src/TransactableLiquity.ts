...
export interface TransactableLiquity {
   ...
   *                           {@link @u/lib-base-u#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @u/lib-base-u#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link @u/lib-base-u#LUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link @u/lib-base-u#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @u/lib-base-u#StabilityDeposit.lqtyReward | LQTY reward}.
   */
  ...
  /**
   * Withdraw {@link @u/lib-base-u#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @u/lib-base-u#StabilityDeposit.lqtyReward | LQTY reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link @u/lib-base-u#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link @u/lib-base-u#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link @u/lib-base-u#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link @u/lib-base-u#LQTYStake.collateralGain | collateral gain} and
   * {@link @u/lib-base-u#LQTYStake.lusdGain | LUSD gain}.
   */
  ...
  /**
   * Withdraw {@link @u/lib-base-u#LQTYStake.collateralGain | collateral gain} and
   * {@link @u/lib-base-u#LQTYStake.lusdGain | LUSD gain} from LQTY stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * {@link @u/lib-base-u#TransactableLiquity.stakeUniTokens | staking}.
   *
   ...
   * {@link @u/lib-base-u#TransactableLiquity.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
