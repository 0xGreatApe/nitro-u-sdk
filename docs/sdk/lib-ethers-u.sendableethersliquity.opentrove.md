...
[Home](./index.md) &gt; [lib-ethers-u](./lib-ethers-u.md) &gt; [SendableEthersLiquity](./lib-ethers-u.sendableethersliquity.md) &gt; [openTrove](./lib-ethers-u.sendableethersliquity.opentrove.md)
...
Promise&lt;[SentEthersLiquityTransaction](./lib-ethers-u.sentethersliquitytransaction.md)<!-- -->&lt;[TroveCreationDetails](./lib-base-u.trovecreationdetails.md)<!-- -->&gt;&gt;
