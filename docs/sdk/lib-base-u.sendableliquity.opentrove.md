...
[Home](./index.md) &gt; [lib-base-u](./lib-base-u.md) &gt; [SendableLiquity](./lib-base-u.sendableliquity.md) &gt; [openTrove](./lib-base-u.sendableliquity.opentrove.md)
...
Promise&lt;[SentLiquityTransaction](./lib-base-u.sentliquitytransaction.md)<!-- -->&lt;S, [LiquityReceipt](./lib-base-u.liquityreceipt.md)<!-- -->&lt;R, [TroveCreationDetails](./lib-base-u.trovecreationdetails.md)<!-- -->&gt;&gt;&gt;
