...
[Home](./index.md) &gt; [lib-base-u](./lib-base-u.md) &gt; [PopulatedRedemption](./lib-base-u.populatedredemption.md) &gt; [increaseAmountByMinimumNetDebt](./lib-base-u.populatedredemption.increaseamountbyminimumnetdebt.md)
...
|  --- | --- | --- |
|  maxRedemptionRate | [Decimalish](./lib-base-u.decimalish.md) | Maximum acceptable [redemption rate](./lib-base-u.fees.redemptionrate.md) to use in the new transaction. |
